...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Preparestimuli(Parameters,stimstruct,stimuli,font,stimsize,color,clippingboundary,transparencythreshold,savestim)
...
%                 stimulus = mean(stimulus,3); %black & white
            catch
